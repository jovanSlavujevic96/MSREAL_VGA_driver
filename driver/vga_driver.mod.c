...
MODULE_ALIAS("of:N*T*Cxlnx,axi-dma-mm2s-channel");
MODULE_ALIAS("of:N*T*Cxlnx,axi-dma-mm2s-channelC*");
MODULE_ALIAS("of:N*T*Cvga_dma");
MODULE_ALIAS("of:N*T*Cvga_dmaC*");
